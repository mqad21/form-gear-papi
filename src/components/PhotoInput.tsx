    ...
    <div class="grid md:grid-cols-3 border-b border-gray-300/[.50] dark:border-gray-200/[.10] p-2">
      ...
      <div class="font-light text-sm space-x-2 py-2.5 px-2 space-y-4 flex justify-end -mt-2">
        <Switch>
          ...
          <Match when={config.clientMode == ClientMode.CAWI}>
          ...
          <Match when={config.clientMode == ClientMode.PAPI}>
            ...
            onchange={(e) => { getFileContent(e) }} accept="image/*" id={"inputFile_" + props.component.dataKey}
              class="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold"
              name={props.component.dataKey} />
          </Match>
        </Switch>
